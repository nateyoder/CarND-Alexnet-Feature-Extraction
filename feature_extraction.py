...
layer_weight = tf.Variable(tf.truncated_normal(shape, stddev=1e-2))
layer_bias = tf.Variable(tf.zeros(nb_classes))
logits = tf.nn.xw_plus_b(fc7, layer_weight, layer_bias)
